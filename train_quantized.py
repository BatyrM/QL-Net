...
if case_number == 1:
    ...
    args.out_name = 'mnist_ql_layer'+str(layer_id1)+'.pth'
    ...
    args.out_name = 'mnist_ql_layer'+str(layer_id2)+'.pth'
    ...
    args.out_name = 'mnist_ql_input_layer.pth'
    ...
    args.out_name = 'mnist_ql_input_layer&layer'+str(layer_id1)+'.pth'
    ...
    args.out_name = 'mnist_ql_input_layer&layer'+str(layer_id2)+'.pth'
